...
**Purpose:** Optional web-based database administration
...
│                                                                 │
│   ┌─────────────────┐   ┌─────────────────┐   ┌──────────────┐ │
│   │ pentaho-server  │   │ pentaho-mysql   │   │   adminer    │ │
...
1. docker compose up -d
   ...
   │
   └─► Start pentaho-adminer container (optional)
       └─► Start Adminer web UI
